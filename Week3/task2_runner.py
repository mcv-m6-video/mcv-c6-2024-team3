...
if __name__ == '__main__':
    ...
    for sequence in root_path.iterdir():
        ...
        for video in sequence.iterdir():
            ...
            # Execute yolov9
            os.system(f'python ../yolov9/detect.py --save-txt --save-conf --classes 0 1 2 3 5 7 --weights ../yolov9/weights/YOLOv9StrategyBWeights.pt --conf 0.5 --source {out_frames} --device 0')
