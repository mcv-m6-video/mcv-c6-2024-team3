...
from task1_2 import *
from task4 import BackgroundRemoval
...
def train(config=None):
    with wandb.init(config=config):
        ...
        modelo.train()
        modelo.fast_test(alpha=config.alpha, ro = config.rho, colorSpace=config.colorSpace)
...
if __name__ == '__main__':
    ...
    sweep_id = wandb.sweep(sweep_config, project="OptimizationC6_Task4v1")
