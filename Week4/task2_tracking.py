...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Object tracking using Kalman Filtering and SORT algorithm.')
    parser.add_argument('--det_path', type=str, help='Path to detections directory')
    parser.add_argument('--path_imgs', type=str, help='Path to images directory')
    parser.add_argument('--path_output', type=str, help='Path to output directory')
